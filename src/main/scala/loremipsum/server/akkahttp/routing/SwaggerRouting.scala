...
case class SwaggerRouting(dependencies: ServiceDependencies) extends Routing {
  ...
  val swaggerJsonLayout = (context: Context) => templating.makeTemplateLayout("loremipsum/templates/swagger.json")(context)
  val swaggerUILayout = (context: Context) => templating.makeTemplateLayout("loremipsum/templates/swagger-ui.html")(context)
